...
const SideBar = ({ activeMenu, setActiveMenu }) => {
	...
	return (
		<div
			className={`side-bar transition-all duration-500 ${
				isCollapsed ? 'w-14' : 'w-60'
			}
			${
				isCollapsed ? 'py-3 ' : 'py-1'
			}  bg-white box-shadow  h-full min-h-full overflow-y-auto
		...
		>
			...
			>
				...
				<div
					className={`mt-16 flex min-h-full flex-col gap-y-8 overflow-hidden`}
				>
					{menus.map((m, index) => {
						return (
							<MenuItem
